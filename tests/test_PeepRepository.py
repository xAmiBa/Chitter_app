...
def test_all_peeps_show(db_connection):
    ...
    assert repository.all() == [
        Peep(2, 'What a day, 5k run done! @xAmiBa', 2, '2022-10-17 12:24:55'),
...
def test_if_mentioned(db_connection):
    db_connection.seed('seeds/chitter.sql')
    repository = PeepRepository(db_connection)
    assert repository.search_for_mention("xAmiBa") == [Peep(2, 'What a day, 5k run done! @xAmiBa', 2, '2022-10-17 12:24:55')]